...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='degcn', type=str)
    parser.add_argument('--dataset', default='post17', type=str, help='twitter, rest14, lap14, rest15, rest16')
