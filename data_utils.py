...
class ABSADatesetReader:
    ...
    def __init__(self, dataset='twitter', embed_dim=300, opt=None):
        ...
        fname = {
            'headline 17': {
                'train': './datasets/semeval-2017-task-5-subtask-1',
                'test': './datasets/semeval-2017-task-5-subtask-1'
            },
            'headline17': {
                'train': './datasets/semeval-2017-task-5-subtask-2',
                'test': './datasets/semeval-2017-task-5-subtask-2'
            }
        }
